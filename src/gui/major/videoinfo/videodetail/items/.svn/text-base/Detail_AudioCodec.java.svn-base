 ...
 * Timex: 下午4:28
 */
public class Detail_AudioCodec extends A_Detail {

    private static final String TITLE = "Audio Codec";

    public Detail_AudioCodec() {
        super(TITLE);
    }
    ...
    public void update(final VideoFile videoFile) {
        ...
        setContentText(info.getItemStringValue(VideoFileInfor.AUDIO_CODEC));
    }
}
