...
public abstract class A_ToobarButton extends AbstractAction implements MouseListener {
...
//            g2.fill(new Rectangle(size));
    ...
    public A_ToobarButton(String activeGifString,
                          String inactiveGifString, String activeMouseIconString) {
